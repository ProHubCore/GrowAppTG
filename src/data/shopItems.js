...
export const shopItems = [
  { id: "lumenweed", type: "seed", name: "Люмен-трава", icon: "🪻", image: "/assets/seeds/psychomor-seeds.png", description: "Светящаяся клубная трава для обычной почвы.", pricePerSeed: 20, minStock: 2, maxStock: 6, requiredClubLevel: 1, seedType: "plant" },
