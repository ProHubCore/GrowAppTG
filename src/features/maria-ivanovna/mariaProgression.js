export const MARIA_TRUST_LEVELS = [
  {
    ...
    required: 0,
    icon: "👋",
    reward: "Первые поручения",
    unlockTitle: "Мария берёт тебя в ученики",
    unlockDescription: "Открывается первая цепочка личных поручений Марии Ивановны.",
    unlocks: ["Глава «Чужой двор»", "Первые награды", "Табакко доступен сразу"],
  },
  {
    level: 1,
    title: "Ученик",
    required: 25,
    icon: "💧",
    reward: "Быстрый полив через облачко",
    unlockTitle: "Растения подают сигнал",
    unlockDescription: "Когда растению нужна вода, над ним появляется облачко с каплей. Одно нажатие сокращает текущую стадию роста на 20%.",
    unlocks: ["Облачко полива", "Полив одним нажатием", "−20% времени за полив"],
  },
  {
    level: 2,
    title: "Подручный",
  ...
  },
  {
    ...
    unlockDescription: "В магазине появился состав, который сдвигает урожай к 2–3 предметам и впервые открывает отличное качество.",
    unlocks: ["Питательный раствор", "Урожай 2–3 шт.", "Отличное качество"],
  },
  {
    level: 5,
    title: "Правая рука",
