...
function DistrictScreen({ onOpenClub, onOpenShop, onOpenJoeHouse }) {
  return (
    <div className="district-screen">
      ...
      <button
        className="district-building-button district-joe-house-button"
        onClick={onOpenJoeHouse}
        aria-label="Дом Дяди Джо"
      >
        <span className="district-joe-house-glow" />
        <span className="district-joe-house-roof" />
        <span className="district-joe-house-body">
          <span className="district-joe-house-window" />
          <span className="district-joe-house-door" />
        </span>
