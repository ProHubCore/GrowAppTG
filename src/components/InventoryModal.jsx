...
import { QUALITY_PRICE_MULTIPLIERS, getQualityAmount } from "../data/qualityInventory";

const ITEMS = {
  greenTomato: { name: "Кислоплод", icon: "🟢", basePrice: 4 },
  lumenweed: { name: "Люмен-трава", image: "/assets/plants/psychomor/psychomor-stage-3.png", basePrice: 10 },
